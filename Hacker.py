...
async def all(event):
  ...
  async for usr in client.iter_participants(chat_id):
    ...
    if usrnum == 5:
      if mode == "text_on_cmd":
        txt = f"{usrtxt}\n\n{msg}\n\nMade bY  [𝐊𝐑𝐈𝐒𝐇𝐍𝐀](https://t.me/Ajanabee_Duniya)",✌️🔥"
...
print(">> KRISHNA TAGALL STARTED @Ajanabee_Duniya<<")
